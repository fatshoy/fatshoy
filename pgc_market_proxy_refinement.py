...
# Drop 'empty'/'blank' placeholder columns (header cell literally said so; no data in them).
header_map = {c: v for c, v in header_map.items() if not re.fullmatch(r"(empty|blank)(_\d+)?", v)}
